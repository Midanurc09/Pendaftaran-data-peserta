...
<p>
    ...
    @foreach($datas as $data)
            <tr>
                ...
                <td>{{$data->hobi}}</td>
                <td> 
                <a href="/edit/{{$data->id}}"> <button type="button" class="btn btn-primary"><i class="bi bi-file-earmark-richtext"></i></button></a>
                <a href="/delete/{{$data->id}}"><button type="button" class="btn btn-danger"><i class="bi bi-trash3-fill"></i></button></a>
                </td>
            </tr>
@endforeach
